...
final class TeamEntityTests: XCTestCase {
    ...
    func testTeamEntity_CompositionAnalysis_MixedSkills() {
        // Given
        let players = [
            createPlayer(name: "Beginner", technical: 1, agility: 1, endurance: 1, teamwork: 1),     // Overall: 1.0 (Beginner)
            createPlayer(name: "Novice", technical: 3, agility: 3, endurance: 3, teamwork: 3),       // Overall: 3.0 (Novice)
            createPlayer(name: "Intermediate", technical: 5, agility: 5, endurance: 5, teamwork: 5), // Overall: 5.0 (Intermediate)
            createPlayer(name: "Advanced", technical: 7, agility: 7, endurance: 7, teamwork: 7),     // Overall: 7.0 (Advanced)
    ...
    func testTeamEntity_AddPlayer_DuplicatePlayer_ThrowsError() {
        ...
        XCTAssertThrowsError(try team.addPlayer(player)) { error in
            ...
            if case .playerAlreadyInTeam(let name) = error as? TeamValidationError {
    ...
    private func createPlayer(name: String, technical: Int, agility: Int, endurance: Int, teamwork: Int) -> PlayerEntity {
