...
final class SwiftDataPlayerRepositoryTests: XCTestCase {
    ...
    func testSaveAll_MultiplePlayers_Success() async throws {
        ...
        let playerNames = Set(allPlayers.map { $0.name })
    ...
    func testFetchAll_MultiplePlayers_Success() async throws {
        ...
        let names = fetchedPlayers.map { $0.name }
    ...
    func testFetchSelected_SelectedPlayers_Success() async throws {
        ...
        XCTAssertTrue(selectedPlayers.allSatisfy { $0.isSelected })
        
        let selectedNames = Set(selectedPlayers.map { $0.name })
    ...
    func testFetchByMinimumSkillLevel_FilteredResults_Success() async throws {
        // Given
        let lowSkillPlayer = createTestPlayer(name: "Low Skill", technical: 2, agility: 2, endurance: 2, teamwork: 2) // Overall: 2.0
        let highSkillPlayer = createTestPlayer(name: "High Skill", technical: 8, agility: 8, endurance: 8, teamwork: 8) // Overall: 8.0
        let mediumSkillPlayer = createTestPlayer(name: "Medium Skill", technical: 5, agility: 5, endurance: 5, teamwork: 5) // Overall: 5.0
    ...
    func testDeleteAll_MultiplePlayers_Success() async throws {
        ...
        let remainingNames = Set(remainingPlayers.map { $0.name })
